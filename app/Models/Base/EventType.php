...
abstract class EventType implements ActiveRecordInterface
{
    ...
    public function setTypename($v)
    {
        ...
        if ($this->typename !== $v) {
            $this->typename = $v;
            $this->modifiedColumns[EventTypeTableMap::COL_TYPENAME] = true;
        }
    ...
    public function setDsc($v)
    {
        ...
        if ($this->dsc !== $v) {
            $this->dsc = $v;
            $this->modifiedColumns[EventTypeTableMap::COL_DSC] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EventTypeTableMap::translateFieldName('Typename', TableMap::TYPE_PHPNAME, $indexType)];
            $this->typename = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EventTypeTableMap::translateFieldName('Dsc', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = EventTypeTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EventTypeTableMap::COL_TYPENAME)) {
            $modifiedColumns[':p' . $index++]  = 'TypeName';
        }
        if ($this->isColumnModified(EventTypeTableMap::COL_DSC)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventTypeTableMap::COL_TYPENAME)) {
            $criteria->add(EventTypeTableMap::COL_TYPENAME, $this->typename);
        }
        if ($this->isColumnModified(EventTypeTableMap::COL_DSC)) {
            $criteria->add(EventTypeTableMap::COL_DSC, $this->dsc);
        }
     ...
     * @return ObjectCollection|ChildEvent[] List of ChildEvent objects
     */
    public function getEventsJoinTimeline(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildEventQuery::create(null, $criteria);
        $query->joinWith('Timeline', $joinBehavior);
