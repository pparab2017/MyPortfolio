 ...
 * @method     ChildEventTypeQuery orderByTypename($order = Criteria::ASC) Order by the TypeName column
 * @method     ChildEventTypeQuery orderByDsc($order = Criteria::ASC) Order by the Dsc column
 *
 * @method     ChildEventTypeQuery groupById() Group by the id column
 * @method     ChildEventTypeQuery groupByTypename() Group by the TypeName column
 * @method     ChildEventTypeQuery groupByDsc() Group by the Dsc column
 *
 ...
 * @method     ChildEventType findOneByTypename(string $TypeName) Return the first ChildEventType filtered by the TypeName column
 * @method     ChildEventType findOneByDsc(string $Dsc) Return the first ChildEventType filtered by the Dsc column *
 ...
 * @method     ChildEventType requireOneByTypename(string $TypeName) Return the first ChildEventType filtered by the TypeName column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildEventType requireOneByDsc(string $Dsc) Return the first ChildEventType filtered by the Dsc column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildEventType[]|ObjectCollection findByTypename(string $TypeName) Return ChildEventType objects filtered by the TypeName column
 * @method     ChildEventType[]|ObjectCollection findByDsc(string $Dsc) Return ChildEventType objects filtered by the Dsc column
...
abstract class EventTypeQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\EventTypeQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EventType', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, TypeName, Dsc FROM Event_Type WHERE id = :p0';
        try {
    ...
    public function filterByTypename($typename = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EventTypeTableMap::COL_TYPENAME, $typename, $comparison);
    }
    ...
    public function filterByDsc($dsc = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(EventTypeTableMap::COL_DSC, $dsc, $comparison);
    }
    ...
    public function filterByEvent($event, $comparison = null)
    {
        if ($event instanceof \Event) {
            return $this
                ->addUsingAlias(EventTypeTableMap::COL_ID, $event->getTypeid(), $comparison);
