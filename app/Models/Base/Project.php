...
abstract class Project implements ActiveRecordInterface
{
    ...
    /**
     * The value for the videolink field.
     *
     * @var        string
     */
    protected $videolink;
    ...
    /**
     * The value for the gitlink field.
     *
     * @var        string
     */
    protected $gitlink;
    ...
    /**
     * Get the [videolink] column value.
     *
     * @return string
     */
    ...
    public function setLangId($v)
    {
        ...
        if ($this->lang_id !== $v) {
            $this->lang_id = $v;
            $this->modifiedColumns[ProjectTableMap::COL_LANG_ID] = true;
        }
    ...
    /**
     * Set the value of [des] column.
     *
     * @param string $v new value
     * @return $this|\Project The current object (for fluent API support)
     */
    public function setDes($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->des !== $v) {
            $this->des = $v;
            $this->modifiedColumns[ProjectTableMap::COL_DES] = true;
        }
    ...
    public function setImgUrl($v)
    {
        ...
        if ($this->img_url !== $v) {
            $this->img_url = $v;
            $this->modifiedColumns[ProjectTableMap::COL_IMG_URL] = true;
        }
    ...
    public function setNotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[ProjectTableMap::COL_NOTES] = true;
        }
    ...
    public function setOthers($v)
    {
        ...
        if ($this->others !== $v) {
            $this->others = $v;
            $this->modifiedColumns[ProjectTableMap::COL_OTHERS] = true;
        }
    ...
    /**
     * Set the value of [videolink] column.
     *
     * @param string $v new value
     * @return $this|\Project The current object (for fluent API support)
     */
    public function setVideolink($v)
    {
        ...
        if ($this->videolink !== $v) {
            $this->videolink = $v;
            $this->modifiedColumns[ProjectTableMap::COL_VIDEOLINK] = true;
        }
    ...
    /**
     * Set the value of [gitlink] column.
     *
     * @param string $v new value
     * @return $this|\Project The current object (for fluent API support)
     */
    public function setGitlink($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->gitlink !== $v) {
            $this->gitlink = $v;
            $this->modifiedColumns[ProjectTableMap::COL_GITLINK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProjectTableMap::translateFieldName('LangId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lang_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProjectTableMap::translateFieldName('Des', TableMap::TYPE_PHPNAME, $indexType)];
            $this->des = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ProjectTableMap::translateFieldName('ImgUrl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->img_url = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ProjectTableMap::translateFieldName('Notes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->notes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ProjectTableMap::translateFieldName('Others', TableMap::TYPE_PHPNAME, $indexType)];
            $this->others = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ProjectTableMap::translateFieldName('Videolink', TableMap::TYPE_PHPNAME, $indexType)];
            $this->videolink = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ProjectTableMap::translateFieldName('Gitlink', TableMap::TYPE_PHPNAME, $indexType)];
            $this->gitlink = (null !== $col) ? (string) $col : null;
            $this->resetModified();
    ...
    {
        if ($this->aLanguage !== null && $this->lang_id !== $this->aLanguage->getId()) {
            $this->aLanguage = null;
        }
    } // ensureConsistency
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProjectTableMap::COL_LANG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'Lang_id';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_DES)) {
            $modifiedColumns[':p' . $index++]  = 'des';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_IMG_URL)) {
            $modifiedColumns[':p' . $index++]  = 'img_url';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_NOTES)) {
            $modifiedColumns[':p' . $index++]  = 'Notes';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_OTHERS)) {
            $modifiedColumns[':p' . $index++]  = 'Others';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_VIDEOLINK)) {
            $modifiedColumns[':p' . $index++]  = 'videoLink';
        }
        if ($this->isColumnModified(ProjectTableMap::COL_GITLINK)) {
            $modifiedColumns[':p' . $index++]  = 'gitLink';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'Lang_id':
                        ...
                        break;
                    case 'des':
                        $stmt->bindValue($identifier, $this->des, PDO::PARAM_STR);
                        break;
                    case 'img_url':
                    ...
                    case 'Others':
                        ...
                        break;
                    case 'videoLink':
                        $stmt->bindValue($identifier, $this->videolink, PDO::PARAM_STR);
                        break;
                    case 'gitLink':
                        $stmt->bindValue($identifier, $this->gitlink, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[6] => $this->getOthers(),
            $keys[7] => $this->getVideolink(),
            $keys[8] => $this->getGitlink(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setLangId($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setDes($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setImgUrl($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setNotes($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setOthers($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setVideolink($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setGitlink($arr[$keys[8]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectTableMap::COL_LANG_ID)) {
            $criteria->add(ProjectTableMap::COL_LANG_ID, $this->lang_id);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_DES)) {
            $criteria->add(ProjectTableMap::COL_DES, $this->des);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_IMG_URL)) {
            $criteria->add(ProjectTableMap::COL_IMG_URL, $this->img_url);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_NOTES)) {
            $criteria->add(ProjectTableMap::COL_NOTES, $this->notes);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_OTHERS)) {
            $criteria->add(ProjectTableMap::COL_OTHERS, $this->others);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_VIDEOLINK)) {
            $criteria->add(ProjectTableMap::COL_VIDEOLINK, $this->videolink);
        }
        if ($this->isColumnModified(ProjectTableMap::COL_GITLINK)) {
            $criteria->add(ProjectTableMap::COL_GITLINK, $this->gitlink);
        }
    ...
    {
        if ($this->aLanguage === null && ($this->lang_id !== null)) {
            $this->aLanguage = ChildLanguageQuery::create()->findPk($this->lang_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLanguage->addProjects($this);
             */
        }
    ...
    {
        if (null !== $this->aLanguage) {
            $this->aLanguage->removeProject($this);
        }
        $this->id = null;
        $this->name = null;
        $this->lang_id = null;
