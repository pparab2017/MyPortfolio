 ...
 * @method     ChildProjectQuery orderByLangId($order = Criteria::ASC) Order by the Lang_id column
 * @method     ChildProjectQuery orderByDes($order = Criteria::ASC) Order by the des column
 * @method     ChildProjectQuery orderByImgUrl($order = Criteria::ASC) Order by the img_url column
 * @method     ChildProjectQuery orderByNotes($order = Criteria::ASC) Order by the Notes column
 * @method     ChildProjectQuery orderByOthers($order = Criteria::ASC) Order by the Others column
 * @method     ChildProjectQuery orderByVideolink($order = Criteria::ASC) Order by the videoLink column
 * @method     ChildProjectQuery orderByGitlink($order = Criteria::ASC) Order by the gitLink column
 *
 * @method     ChildProjectQuery groupById() Group by the id column
 * @method     ChildProjectQuery groupByName() Group by the Name column
 * @method     ChildProjectQuery groupByLangId() Group by the Lang_id column
 * @method     ChildProjectQuery groupByDes() Group by the des column
 * @method     ChildProjectQuery groupByImgUrl() Group by the img_url column
 * @method     ChildProjectQuery groupByNotes() Group by the Notes column
 * @method     ChildProjectQuery groupByOthers() Group by the Others column
 * @method     ChildProjectQuery groupByVideolink() Group by the videoLink column
 * @method     ChildProjectQuery groupByGitlink() Group by the gitLink column
 *
 ...
 *
 * @method     ChildProjectQuery leftJoinLanguage($relationAlias = null) Adds a LEFT JOIN clause to the query using the Language relation
 * @method     ChildProjectQuery rightJoinLanguage($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Language relation
 * @method     ChildProjectQuery innerJoinLanguage($relationAlias = null) Adds a INNER JOIN clause to the query using the Language relation
 *
 * @method     ChildProjectQuery joinWithLanguage($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Language relation
 *
 * @method     ChildProjectQuery leftJoinWithLanguage() Adds a LEFT JOIN clause and with to the query using the Language relation
 * @method     ChildProjectQuery rightJoinWithLanguage() Adds a RIGHT JOIN clause and with to the query using the Language relation
 * @method     ChildProjectQuery innerJoinWithLanguage() Adds a INNER JOIN clause and with to the query using the Language relation
 *
 ...
 * @method     ChildProject findOneByLangId(int $Lang_id) Return the first ChildProject filtered by the Lang_id column
 * @method     ChildProject findOneByDes(string $des) Return the first ChildProject filtered by the des column
 * @method     ChildProject findOneByImgUrl(string $img_url) Return the first ChildProject filtered by the img_url column
 * @method     ChildProject findOneByNotes(string $Notes) Return the first ChildProject filtered by the Notes column
 * @method     ChildProject findOneByOthers(string $Others) Return the first ChildProject filtered by the Others column
 * @method     ChildProject findOneByVideolink(string $videoLink) Return the first ChildProject filtered by the videoLink column
 * @method     ChildProject findOneByGitlink(string $gitLink) Return the first ChildProject filtered by the gitLink column *
 ...
 * @method     ChildProject requireOneByLangId(int $Lang_id) Return the first ChildProject filtered by the Lang_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProject requireOneByDes(string $des) Return the first ChildProject filtered by the des column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProject requireOneByImgUrl(string $img_url) Return the first ChildProject filtered by the img_url column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProject requireOneByNotes(string $Notes) Return the first ChildProject filtered by the Notes column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProject requireOneByOthers(string $Others) Return the first ChildProject filtered by the Others column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProject requireOneByVideolink(string $videoLink) Return the first ChildProject filtered by the videoLink column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildProject requireOneByGitlink(string $gitLink) Return the first ChildProject filtered by the gitLink column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildProject[]|ObjectCollection findByLangId(int $Lang_id) Return ChildProject objects filtered by the Lang_id column
 * @method     ChildProject[]|ObjectCollection findByDes(string $des) Return ChildProject objects filtered by the des column
 * @method     ChildProject[]|ObjectCollection findByImgUrl(string $img_url) Return ChildProject objects filtered by the img_url column
 * @method     ChildProject[]|ObjectCollection findByNotes(string $Notes) Return ChildProject objects filtered by the Notes column
 * @method     ChildProject[]|ObjectCollection findByOthers(string $Others) Return ChildProject objects filtered by the Others column
 * @method     ChildProject[]|ObjectCollection findByVideolink(string $videoLink) Return ChildProject objects filtered by the videoLink column
 * @method     ChildProject[]|ObjectCollection findByGitlink(string $gitLink) Return ChildProject objects filtered by the gitLink column
...
abstract class ProjectQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, Name, Lang_id, des, img_url, Notes, Others, videoLink, gitLink FROM Project WHERE id = :p0';
        try {
    ...
    public function filterByLangId($langId = null, $comparison = null)
    {
        if (is_array($langId)) {
            $useMinMax = false;
            if (isset($langId['min'])) {
                $this->addUsingAlias(ProjectTableMap::COL_LANG_ID, $langId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($langId['max'])) {
                $this->addUsingAlias(ProjectTableMap::COL_LANG_ID, $langId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjectTableMap::COL_LANG_ID, $langId, $comparison);
    }
    ...
    public function filterByDes($des = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProjectTableMap::COL_DES, $des, $comparison);
    }
    ...
    public function filterByImgUrl($imgUrl = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProjectTableMap::COL_IMG_URL, $imgUrl, $comparison);
    }
    ...
    public function filterByNotes($notes = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProjectTableMap::COL_NOTES, $notes, $comparison);
    }
    ...
    public function filterByOthers($others = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProjectTableMap::COL_OTHERS, $others, $comparison);
    }
    ...
    public function filterByVideolink($videolink = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ProjectTableMap::COL_VIDEOLINK, $videolink, $comparison);
    }

    /**
     * Filter the query on the gitLink column
     *
     * Example usage:
     * <code>
     * $query->filterByGitlink('fooValue');   // WHERE gitLink = 'fooValue'
     * $query->filterByGitlink('%fooValue%'); // WHERE gitLink LIKE '%fooValue%'
     * </code>
     *
     * @param     string $gitlink The value to use as filter.
     *              Accepts wildcards (* and % trigger a LIKE)
     * @param     string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this|ChildProjectQuery The current query, for fluid interface
     */
    public function filterByGitlink($gitlink = null, $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($gitlink)) {
                $comparison = Criteria::IN;
        ...
        return $this->addUsingAlias(ProjectTableMap::COL_GITLINK, $gitlink, $comparison);
    }
    ...
    public function filterByLanguage($language, $comparison = null)
    {
        if ($language instanceof \Language) {
            return $this
                ->addUsingAlias(ProjectTableMap::COL_LANG_ID, $language->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ProjectTableMap::COL_LANG_ID, $language->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
