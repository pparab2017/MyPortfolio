...
/**
 * Base class that represents a row from the 'TimeLine' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Timeline implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TimelineTableMap';
    ...
    /**
     * Initializes internal state of Base\Timeline object.
     */
    ...
    /**
     * Compares this with another <code>Timeline</code> instance.  If
     * <code>obj</code> is an instance of <code>Timeline</code>, delegates to
     * <code>equals(Timeline)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Timeline The current object, for fluid interface
     */
     ...
     * @return $this|\Timeline The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[TimelineTableMap::COL_ID] = true;
        }
    ...
    public function setFromDate($v)
    {
        ...
        if ($this->from_date !== null || $dt !== null) {
            if ($this->from_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->from_date->format("Y-m-d H:i:s.u")) {
                $this->from_date = $dt === null ? null : clone $dt;
                $this->modifiedColumns[TimelineTableMap::COL_FROM_DATE] = true;
            }
    ...
    public function setToDate($v)
    {
        ...
        if ($this->to_date !== null || $dt !== null) {
            if ($this->to_date === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->to_date->format("Y-m-d H:i:s.u")) {
                $this->to_date = $dt === null ? null : clone $dt;
                $this->modifiedColumns[TimelineTableMap::COL_TO_DATE] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TimelineTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TimelineTableMap::translateFieldName('FromDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->from_date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TimelineTableMap::translateFieldName('ToDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 3; // 3 = TimelineTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Timeline'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildTimelineQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Timeline::setDeleted()
     * @see Timeline::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildTimelineQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TimelineTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[TimelineTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . TimelineTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(TimelineTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(TimelineTableMap::COL_FROM_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'from_Date';
        }
        if ($this->isColumnModified(TimelineTableMap::COL_TO_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'to_Date';
        }

        $sql = sprintf(
            'INSERT INTO TimeLine (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'from_Date':
                        $stmt->bindValue($identifier, $this->from_date ? $this->from_date->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                    case 'to_Date':
                        $stmt->bindValue($identifier, $this->to_date ? $this->to_date->format("Y-m-d H:i:s.u") : null, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    {
        $pos = TimelineTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Timeline'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Timeline'][$this->hashCode()] = true;
        $keys = TimelineTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getFromDate(),
            $keys[2] => $this->getToDate(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setFromDate($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setToDate($arr[$keys[2]]);
        }
    }
    ...
    {
        $criteria = new Criteria(TimelineTableMap::DATABASE_NAME);

        if ($this->isColumnModified(TimelineTableMap::COL_ID)) {
            $criteria->add(TimelineTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(TimelineTableMap::COL_FROM_DATE)) {
            $criteria->add(TimelineTableMap::COL_FROM_DATE, $this->from_date);
        }
        if ($this->isColumnModified(TimelineTableMap::COL_TO_DATE)) {
            $criteria->add(TimelineTableMap::COL_TO_DATE, $this->to_date);
        }
    ...
    {
        $criteria = ChildTimelineQuery::create();
        $criteria->add(TimelineTableMap::COL_ID, $this->id);
     ...
     * If this ChildTimeline is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildTimeline The current object (for fluent API support)
     */
     ...
     * Otherwise if this Timeline is new, it will return
     * an empty collection; or if this Timeline has previously
     * been saved, it will retrieve related Events from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Timeline.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(TimelineTableMap::DEFAULT_STRING_FORMAT);
    }
