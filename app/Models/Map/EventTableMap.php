...
class EventTableMap extends TableMap
{
    ...
    /**
     * the column name for the Dsc field
     */
    const COL_DSC = 'Event.Dsc';

    /**
     * the column name for the Company field
     */
    const COL_COMPANY = 'Event.Company';

    /**
     * the column name for the TimeLineID field
     */
    const COL_TIMELINEID = 'Event.TimeLineID';

    /**
     * the column name for the TypeID field
     */
    const COL_TYPEID = 'Event.TypeID';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Title', 'Dsc', 'Company', 'Timelineid', 'Typeid', ),
        self::TYPE_CAMELNAME     => array('id', 'title', 'dsc', 'company', 'timelineid', 'typeid', ),
        self::TYPE_COLNAME       => array(EventTableMap::COL_ID, EventTableMap::COL_TITLE, EventTableMap::COL_DSC, EventTableMap::COL_COMPANY, EventTableMap::COL_TIMELINEID, EventTableMap::COL_TYPEID, ),
        self::TYPE_FIELDNAME     => array('id', 'Title', 'Dsc', 'Company', 'TimeLineID', 'TypeID', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Title' => 1, 'Dsc' => 2, 'Company' => 3, 'Timelineid' => 4, 'Typeid' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'title' => 1, 'dsc' => 2, 'company' => 3, 'timelineid' => 4, 'typeid' => 5, ),
        self::TYPE_COLNAME       => array(EventTableMap::COL_ID => 0, EventTableMap::COL_TITLE => 1, EventTableMap::COL_DSC => 2, EventTableMap::COL_COMPANY => 3, EventTableMap::COL_TIMELINEID => 4, EventTableMap::COL_TYPEID => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'Title' => 1, 'Dsc' => 2, 'Company' => 3, 'TimeLineID' => 4, 'TypeID' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('Title', 'Title', 'VARCHAR', false, 300, null);
        $this->addColumn('Dsc', 'Dsc', 'VARCHAR', false, 1000, null);
        $this->addColumn('Company', 'Company', 'VARCHAR', false, 45, null);
        $this->addForeignKey('TimeLineID', 'Timelineid', 'INTEGER', 'TimeLine', 'id', false, null, null);
        $this->addForeignKey('TypeID', 'Typeid', 'INTEGER', 'Event_Type', 'id', false, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('EventType', '\\EventType', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':TypeID',
    1 => ':id',
        ...
        $this->addRelation('Timeline', '\\Timeline', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':TimeLineID',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(EventTableMap::COL_DSC);
            $criteria->addSelectColumn(EventTableMap::COL_COMPANY);
            $criteria->addSelectColumn(EventTableMap::COL_TIMELINEID);
            $criteria->addSelectColumn(EventTableMap::COL_TYPEID);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.Title');
            $criteria->addSelectColumn($alias . '.Dsc');
            $criteria->addSelectColumn($alias . '.Company');
            $criteria->addSelectColumn($alias . '.TimeLineID');
