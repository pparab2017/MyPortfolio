...
/**
 * This class defines the structure of the 'Event_Type' table.
 *
 *
 *
...
class EventTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.EventTypeTableMap';
     ...
     */
    const COL_ID = 'Event_Type.id';

    /**
     * the column name for the TypeName field
     */
    const COL_TYPENAME = 'Event_Type.TypeName';

    /**
     * the column name for the Dsc field
     */
    const COL_DSC = 'Event_Type.Dsc';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Typename', 'Dsc', ),
        self::TYPE_CAMELNAME     => array('id', 'typename', 'dsc', ),
        self::TYPE_COLNAME       => array(EventTypeTableMap::COL_ID, EventTypeTableMap::COL_TYPENAME, EventTypeTableMap::COL_DSC, ),
        self::TYPE_FIELDNAME     => array('id', 'TypeName', 'Dsc', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Typename' => 1, 'Dsc' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'typename' => 1, 'dsc' => 2, ),
        self::TYPE_COLNAME       => array(EventTypeTableMap::COL_ID => 0, EventTypeTableMap::COL_TYPENAME => 1, EventTypeTableMap::COL_DSC => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'TypeName' => 1, 'Dsc' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('TypeName', 'Typename', 'VARCHAR', false, 45, null);
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(EventTypeTableMap::COL_ID);
            $criteria->addSelectColumn(EventTypeTableMap::COL_TYPENAME);
            $criteria->addSelectColumn(EventTypeTableMap::COL_DSC);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(EventTypeTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(EventTypeTableMap::COL_ID) && $criteria->keyContainsValue(EventTypeTableMap::COL_ID) ) {
