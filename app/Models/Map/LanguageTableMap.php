...
class LanguageTableMap extends TableMap
{
    ...
    /**
     * the column name for the logo_img_url field
     */
    const COL_LOGO_IMG_URL = 'Language.logo_img_url';

    /**
     * the column name for the des field
     */
    const COL_DES = 'Language.des';

    /**
     * the column name for the color field
     */
    const COL_COLOR = 'Language.color';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'LogoImgUrl', 'Des', 'Color', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'logoImgUrl', 'des', 'color', ),
        self::TYPE_COLNAME       => array(LanguageTableMap::COL_ID, LanguageTableMap::COL_NAME, LanguageTableMap::COL_LOGO_IMG_URL, LanguageTableMap::COL_DES, LanguageTableMap::COL_COLOR, ),
        self::TYPE_FIELDNAME     => array('id', 'Name', 'logo_img_url', 'des', 'color', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'LogoImgUrl' => 2, 'Des' => 3, 'Color' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'logoImgUrl' => 2, 'des' => 3, 'color' => 4, ),
        self::TYPE_COLNAME       => array(LanguageTableMap::COL_ID => 0, LanguageTableMap::COL_NAME => 1, LanguageTableMap::COL_LOGO_IMG_URL => 2, LanguageTableMap::COL_DES => 3, LanguageTableMap::COL_COLOR => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'Name' => 1, 'logo_img_url' => 2, 'des' => 3, 'color' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('logo_img_url', 'LogoImgUrl', 'VARCHAR', true, 200, null);
        $this->addColumn('des', 'Des', 'VARCHAR', true, 500, null);
        $this->addColumn('color', 'Color', 'VARCHAR', true, 45, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LanguageTableMap::COL_LOGO_IMG_URL);
            $criteria->addSelectColumn(LanguageTableMap::COL_DES);
            $criteria->addSelectColumn(LanguageTableMap::COL_COLOR);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.Name');
            $criteria->addSelectColumn($alias . '.logo_img_url');
